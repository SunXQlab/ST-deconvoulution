...
#start = time.clock()
adata_vis = sc.read_csv("/home/yll/cell2loction/merfish_simulated150_spatialcnt_data.csv")
print(adata_vis)
...
adata_ref = sc.read_csv("/home/yll/cell2loction/mefish_singlecell_new_data.csv")
print(adata_ref)
