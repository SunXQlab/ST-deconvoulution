...
sc_adata = sc.read_csv("/home/yll/cell2loction/mefish_singlecell_new_data.csv")
...
st_adata = sc.read_csv("/home/yll/cell2loction/merfish_spatial_data.csv")
#print(adata_vis)
...
cell2location.models.Cell2location.setup_anndata(st_adata)  
